...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone IV E" DIRECTION="ADD" OPTIMIZE="SPEED" PIPELINE=14 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=11 WIDTH_MAN=52 clock dataa datab result
...
module  fp_add_sub_altbarrel_shift_65e
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fp_add_sub_altbarrel_shift_65e


//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone IV E" PIPELINE=1 REGISTER_OUTPUT="NO" SHIFTDIR="RIGHT" WIDTH=55 WIDTHDIST=6 aclr clk_en clock data distance result
//VERSION_BEGIN 18.1 cbx_altbarrel_shift 2018:09:12:13:04:24:SJ cbx_mgl 2018:09:12:13:10:36:SJ  VERSION_END
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_sub_altbarrel_shift_c8g
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	assign
		...
		smux_w = {((({55{(sel_w[5] & (~ dir_w[5]))}} & {sbit_w[297:275], pad_w[31:0]}) | ({55{(sel_w[5] & dir_w[5])}} & {pad_w[31:0], sbit_w[329:307]})) | ({55{(~ sel_w[5])}} & sbit_w[329:275])), ((({55{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[258:220], pad_w[15:0]}) | ({55{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[274:236]})) | ({55{(~ sel_w[4])}} & sbit_w[274:220])), ((({55{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[211:165], pad_w[7:0]}) | ({55{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[219:173]})) | ({55{(~ sel_w[3])}} & sbit_w[219:165])), ((({55{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[160:110], pad_w[3:0]}) | ({55{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[164:114]})) | ({55{(~ sel_w[2])}} & sbit_w[164:110])), ((({55{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[107:55], pad_w[1:0]}) | ({55{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[109:57]})) | ({55{(~ sel_w[1])}} & sbit_w[109:55])), ((({55{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[53:0], pad_w[0]}) | ({55{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[54:1]})) | ({55{(~ sel_w[0])}} & sbit_w[54:0]))};
endmodule //fp_add_sub_altbarrel_shift_c8g
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_sub_altpriority_encoder_tv8
	( 
	data,
	q) ;
	input   [31:0]  data;
...
endmodule //fp_add_sub_altpriority_encoder_tv8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_sub_altpriority_encoder_te9
	( 
	data,
	q,
	zero) ;
...
endmodule //fp_add_sub_altpriority_encoder_te9

//synthesis_resources = reg 6 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_sub_altpriority_encoder_uu8
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	fp_add_sub_altpriority_encoder_tv8   altpriority_encoder7
	( 
	.data(data[31:0]),
	.q(wire_altpriority_encoder7_q));
	fp_add_sub_altpriority_encoder_te9   altpriority_encoder8
	( 
	.data(data[63:32]),
...
endmodule //fp_add_sub_altpriority_encoder_uu8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_sub_altpriority_encoder_hi9
	( 
	data,
	q,
	zero) ;
...
endmodule //fp_add_sub_altpriority_encoder_hi9
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_sub_altpriority_encoder_h39
	( 
	data,
	q) ;
	input   [31:0]  data;
...
endmodule //fp_add_sub_altpriority_encoder_h39

//synthesis_resources = reg 6 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_sub_altpriority_encoder_ina
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	fp_add_sub_altpriority_encoder_hi9   altpriority_encoder25
	( 
	.data(data[31:0]),
	.q(wire_altpriority_encoder25_q),
	.zero(wire_altpriority_encoder25_zero));
	fp_add_sub_altpriority_encoder_h39   altpriority_encoder26
	( 
	.data(data[63:32]),
...
endmodule //fp_add_sub_altpriority_encoder_ina

//synthesis_resources = lpm_add_sub 15 lpm_compare 1 reg 1181 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_sub_altfp_add_sub_v7j
	( 
	clock,
	dataa,
	datab,
	...
	fp_add_sub_altbarrel_shift_65e   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	fp_add_sub_altbarrel_shift_c8g   rbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	fp_add_sub_altpriority_encoder_uu8   leading_zeroes_cnt
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	fp_add_sub_altpriority_encoder_ina   trailing_zeros_cnt
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //fp_add_sub_altfp_add_sub_v7j
//VALID FILE
...
module fp_add_sub (
	...
	fp_add_sub_altfp_add_sub_v7j	fp_add_sub_altfp_add_sub_v7j_component (
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
				.result (sub_wire0));
