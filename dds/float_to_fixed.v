...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone IV E" OPERATION="FLOAT2INT" ROUNDING="TO_NEAREST" WIDTH_DATA=64 WIDTH_EXP_INPUT=11 WIDTH_EXP_OUTPUT=8 WIDTH_INT=32 WIDTH_MAN_INPUT=52 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 clock dataa result
...
//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone IV E" PIPELINE=2 SHIFTDIR="LEFT" SHIFTTYPE="LOGICAL" WIDTH=83 WIDTHDIST=7 aclr clk_en clock data distance result
...
module  float_to_fixed_altbarrel_shift_50g
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //float_to_fixed_altbarrel_shift_50g

//synthesis_resources = lpm_add_sub 5 lpm_compare 4 reg 402 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  float_to_fixed_altfp_convert_63n
	( 
	clock,
	dataa,
	result) ;
	...
	float_to_fixed_altbarrel_shift_50g   altbarrel_shift6
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //float_to_fixed_altfp_convert_63n
//VALID FILE
...
module float_to_fixed (
	...
	float_to_fixed_altfp_convert_63n	float_to_fixed_altfp_convert_63n_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
