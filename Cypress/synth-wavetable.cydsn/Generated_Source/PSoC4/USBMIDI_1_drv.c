    ...
    if ((tempReg & USBMIDI_1_MODE_ACKD) != 0u)
    {
        ...
        if (modifyReg != 0u)
        {
            ...
            if ((tempReg & USBMIDI_1_MODE_SETUP_RCVD) == 0u)
            {
                ...
                tempReg = (uint32) USBMIDI_1_ep0Toggle | USBMIDI_1_ep0Count;
...
void USBMIDI_1_HandleSetup(void) 
{
    ...
    */
    ...
    USBMIDI_1_EP0_CR_REG = (uint32) requestHandled;
    requestHandled = (uint8) USBMIDI_1_EP0_CR_REG;
...
void USBMIDI_1_LoadEP0(void) 
{
    ...
    {
        USBMIDI_1_EP0_DR_BASE.epData[ep0Count] = (uint32) *USBMIDI_1_currentTD.pData;
...
void USBMIDI_1_NoDataControlStatusStage(void) 
{
    if (0u != USBMIDI_1_deviceAddress)
    {
        ...
        USBMIDI_1_CR0_REG = (uint32) USBMIDI_1_deviceAddress | USBMIDI_1_CR0_ENABLE;
