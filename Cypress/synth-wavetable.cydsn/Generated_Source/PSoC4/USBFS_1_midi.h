...
#define USBFS_1_ENABLE_MIDI_API    (0u != (1u))
...
#define USBFS_1_ISR_SERVICE_MIDI_OUT \
            ((USBFS_1_ENABLE_MIDI_API != 0u) && (USBFS_1_MIDI_OUT_BUFF_SIZE > 0) && \
             (USBFS_1_EP_MANAGEMENT_DMA_AUTO))
...
/*******************************************************************************
* Function Name: USBFS_1_callbackLocalMidiEvent
****************************************************************************//**
*
...
#if (CY_PSOC4)
    #define USBFS_1_CUSTOM_UART_RX_PRIOR_NUM   (0x01u)
    #define USBFS_1_CUSTOM_UART_TX_PRIOR_NUM   (0x02u)
#else
...
#define USBFS_1_MIDI_EP_Init           USBFS_1_MIDI_Init
#define USBFS_1_MIDI_OUT_EP_Service    USBFS_1_MIDI_OUT_Service
