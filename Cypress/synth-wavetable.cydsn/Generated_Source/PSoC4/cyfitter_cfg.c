...
static void ClockSetup(void)
{
	...
	CY_SET_REG32(CYREG_CLK_PLL0_CONFIG, 0x80020F15u);
	CY_SET_REG32(CYREG_CLK_PLL1_CONFIG, 0x80020F15u);
	CyDelayCycles(240u);
	CY_SET_REG32(CYREG_CLK_PLL0_CONFIG, 0xC0020F15u);
	...
	CY_SET_REG32((void *)CYREG_PERI_DIV_24_5_CTL, 0x0176FF00u);
	...
	CY_SET_REG32((void *)CYREG_PERI_DIV_16_CTL4, 0x00000500u);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG32((void CYFAR *)CYREG_SAR_MUX_SWITCH0, 0x000400E0u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_SAR_MUX_SWITCH_HW_CTRL, 0x000400E0u);
...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDB_INT_CLK_CTL, 0x01u);
	{
		static const uint32 CYCODE cy_cfg_addr_table[] = {
			...
			0x400F352Bu, /* Base address: 0x400F3500 Count: 43 */
			0x400F362Cu, /* Base address: 0x400F3600 Count: 44 */
			0x400F373Cu, /* Base address: 0x400F3700 Count: 60 */
			...
			0x400F450Au, /* Base address: 0x400F4500 Count: 10 */
			0x400F470Cu, /* Base address: 0x400F4700 Count: 12 */
		...
		CY_SET_REG8((void *)(CYREG_UDB_UDB_TR_CLK_CTL), 0x01u);

		/* HSIOM Starting address: CYDEV_HSIOM_BASE */
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL1), 0x00000600u);
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA0_CFG8), 0x80000000u);

		/* UDB_PA_1 Starting address: CYDEV_UDB_PA1_BASE */
		CY_SET_REG32((void *)(CYDEV_UDB_PA1_BASE), 0x00990000u);
		CY_SET_REG32((void *)(CYREG_UDB_PA1_CFG8), 0x00450000u);
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA7_CFG8), 0xB1000000u);

		/* TCPWM_CNT0 Starting address: CYDEV_TCPWM_CNT0_TR_CTRL0 */
		CY_SET_REG32((void *)(CYREG_TCPWM_CNT0_TR_CTRL0), 0x000000F0u);

		/* TCPWM_CNT1 Starting address: CYDEV_TCPWM_CNT1_TR_CTRL0 */
		CY_SET_REG32((void *)(CYREG_TCPWM_CNT1_TR_CTRL0), 0x000000E0u);

		/* INT_SELECT Starting address: CYDEV_CPUSS_INT_SEL */
		CY_SET_REG32((void *)(CYREG_CPUSS_INT_SEL), 0x0000001Fu);

		/* TR_GROUP0 Starting address: CYDEV_PERI_TR_GROUP0_TR_OUT_CTL0 */
		CY_SET_REG32((void *)(CYREG_PERI_TR_GROUP0_TR_OUT_CTL0), 0x0000001Du);
		CY_SET_REG32((void *)(CYREG_PERI_TR_GROUP0_TR_OUT_CTL1), 0x0000002Fu);
		CY_SET_REG32((void *)(CYREG_PERI_TR_GROUP0_TR_OUT_CTL2), 0x0000001Cu);

		/* INT_CONFIG Starting address: CYDEV_UDB_INT_CFG */
		CY_SET_REG32((void *)(CYREG_UDB_INT_CFG), 0x0000001Eu);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT0_PC), 0x00000002u);
	...
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT2_BASE), 0x000000EDu);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT2_PC), 0x00006D8Eu);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT2_PC2), 0x000000EDu);
	...
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT5_BASE), 0x00000090u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT5_PC), 0x00C02000u);
