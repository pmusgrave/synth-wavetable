    ...
    if ((tempReg & USBFS_1_MODE_ACKD) != 0u)
    {
        ...
        if (modifyReg != 0u)
        {
            ...
            if ((tempReg & USBFS_1_MODE_SETUP_RCVD) == 0u)
            {
                ...
                tempReg = (uint32) USBFS_1_ep0Toggle | USBFS_1_ep0Count;
...
void USBFS_1_HandleSetup(void) 
{
    ...
    */
    ...
    USBFS_1_EP0_CR_REG = (uint32) requestHandled;
    requestHandled = (uint8) USBFS_1_EP0_CR_REG;
...
void USBFS_1_LoadEP0(void) 
{
    ...
    {
        USBFS_1_EP0_DR_BASE.epData[ep0Count] = (uint32) *USBFS_1_currentTD.pData;
...
void USBFS_1_NoDataControlStatusStage(void) 
{
    if (0u != USBFS_1_deviceAddress)
    {
        ...
        USBFS_1_CR0_REG = (uint32) USBFS_1_deviceAddress | USBFS_1_CR0_ENABLE;
